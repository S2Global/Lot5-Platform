...
class WorldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create world" do
    assert_difference('World.count') do
      post worlds_url, params: { world: { description: @world.description, user_id: @world.user_id } }
    end
  ...
  test "should update world" do
    patch world_url(@world), params: { world: { description: @world.description, user_id: @world.user_id } }
